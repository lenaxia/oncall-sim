...
export const LOG_PROFILES: Record<string, LogProfile> = {
  java_web_service: {
    ...
    lines: [
      ...
      {
        level: "DEBUG",
        message: "HikariPool-1 - keepalive: connection is alive",
        weight: 2,
      },
      { level: "DEBUG", message: "Scheduled task heartbeat fired", weight: 1 },
      {
        level: "INFO",
        message: "GC: minor collection complete — heap 312MB/512MB",
        weight: 1,
      },
      {
        level: "DEBUG",
        message: "Thread pool stats: active=3 queued=0 completed=18204",
        weight: 1,
      },
      {
        level: "INFO",
        message: "Config refresh: no changes detected",
        weight: 1,
      },
      {
        level: "DEBUG",
        message: "Evicted 12 expired entries from response cache",
        weight: 1,
      },
      ...
      {
        level: "INFO",
        message: "POST /v1/charges - 200 OK - 112ms",
        weight: 2,
      },
      {
        level: "INFO",
        message: "GET /v1/payment-methods - 200 OK - 41ms",
        weight: 2,
      },
      {
        level: "DEBUG",
        message: "JDBC connection borrowed from pool in 2ms",
        weight: 2,
      },
      {
        level: "DEBUG",
        message: "JDBC connection returned to pool",
        weight: 2,
      },
  ...
  nodejs_api: {
    ...
    lines: [
      ...
      {
        level: "DEBUG",
        message: "Redis GET hit: session:u9f3a2 (ttl 1742s)",
        weight: 2,
      },
      {
        level: "DEBUG",
        message: "Redis GET hit: catalog:featured (ttl 58s)",
        weight: 1,
      },
      {
        level: "INFO",
        message: "Cron: stale session cleanup ran — 0 removed",
        weight: 1,
      },
      {
        level: "DEBUG",
        message: "DB pool: idle=8 active=2 waiting=0",
        weight: 2,
      },
  ...
  python_worker: {
    ...
    lines: [
      {
        level: "INFO",
        message: "Worker heartbeat — queue depth: 0",
        weight: 3,
      },
      {
        level: "INFO",
        message: "Worker heartbeat — queue depth: 1",
        weight: 2,
      },
      { level: "DEBUG", message: "Celery beat: no tasks due", weight: 2 },
      {
        level: "INFO",
        message: "Task process_payment[a3f2] succeeded in 0.82s",
        weight: 3,
      },
      {
        level: "INFO",
        message: "Task process_payment[b7c1] succeeded in 0.91s",
        weight: 2,
      },
      {
        level: "DEBUG",
        message: "Prefetch multiplier: 4, active=1",
        weight: 1,
      },
      { level: "INFO", message: "DB pool: connections 3/10", weight: 2 },
      {
        level: "DEBUG",
        message: "Cache set: payment_config (ttl=300)",
        weight: 1,
      },
      {
        level: "INFO",
        message: "Rate limiter check: OK (tokens=98/100)",
        weight: 1,
      },
    ],
  },
  sidecar_proxy: {
    ...
    lines: [
      {
        level: "DEBUG",
        message: "[upstream] connection established to 10.0.1.42:8080",
        weight: 3,
      },
      {
        level: "DEBUG",
        message: "[upstream] connection established to 10.0.1.43:8080",
        weight: 2,
      },
      {
        level: "INFO",
        message: "health: upstream cluster healthy (3/3 hosts)",
        weight: 3,
      },
      {
        level: "DEBUG",
        message: "xDS: no config changes from control plane",
        weight: 2,
      },
      {
        level: "DEBUG",
        message:
          "outbound -> 10.0.2.11:5432 [TCP] bytes_sent=142 bytes_recv=88",
        weight: 2,
      },
      {
        level: "INFO",
        message: "circuit breaker: CLOSED (failure rate 0.0%)",
        weight: 2,
      },
      {
        level: "DEBUG",
        message: "TLS session resumed (ticket reuse)",
        weight: 1,
      },
