...
describe("resolveMetricParams — resolvedValue", () => {
  it("resolvedValue defaults to baselineValue when resolved_value not authored", () => {
    const scenario = getFixtureScenario();
    const metricConfig: MetricConfig = {
      archetype: "error_rate",
      baselineValue: 2.5,
  ...
  it("resolvedValue uses authored value when resolved_value is present", () => {
    const scenario = getFixtureScenario();
    const metricConfig: MetricConfig = {
      archetype: "request_rate",
      baselineValue: 350,
  ...
  it("resolvedValue defaults to derived baselineValue when no author baseline either", () => {
    const scenario = getFixtureScenario();
